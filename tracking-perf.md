...
goos: darwin
goarch: amd64
pkg: github.com/markbates/markdownr
...
PASS
ok  	github.com/markbates/markdownr	45.375s
```
...
ok  	github.com/markbates/markdownr	40.809s
```
...
ok      github.com/markbates/markdownr  40.841s
```
...
PASS
ok      github.com/markbates/markdownr  43.477s
```
...
PASS
ok      github.com/markbates/markdownr  42.176s
```
